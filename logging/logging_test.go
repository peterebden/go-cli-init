...
func TestJSONFormatter(t *testing.T) {
	...
	assert.Equal(t, `{"file":"logging/logging_test.go:27","func":"logging_test_lib.TestJSONFormatter","level":"info","module":"test_module","msg":"hello world","time":"1970-01-01T00:00:00.000Z"}`+"\n", line)
}
